...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grafika: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grafika ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Drawer3D.o: Drawer3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Drawer3D.o Drawer3D.cpp

${OBJECTDIR}/GenerateRotation.o: GenerateRotation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GenerateRotation.o GenerateRotation.cpp

${OBJECTDIR}/ShapeRotatorApp.o: ShapeRotatorApp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShapeRotatorApp.o ShapeRotatorApp.cpp

${OBJECTDIR}/ShapeRotatorDlg.o: ShapeRotatorDlg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ShapeRotatorDlg.o ShapeRotatorDlg.cpp

${OBJECTDIR}/vecmat.o: vecmat.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vecmat.o vecmat.cpp
